...
describe('Task Header cloud component', () => {
    ...
    it('[C291943] Should display task details for assigned task', async () => {
        ...
        tasksCloudDemoPage.taskListCloudComponent().getDataTable().checkContentIsDisplayed('Name', basicCreatedTaskName);
        tasksCloudDemoPage.taskListCloudComponent().getDataTable().selectRow('Name', basicCreatedTaskName);
    ...
    it('[C291944] Should display task details for completed task', async () => {
        ...
        tasksCloudDemoPage.taskListCloudComponent().getDataTable().selectRow('Name', completedTaskName);
    ...
    it('[C291945] Should Parent Name and Parent Id not be empty in task details for sub task', async () => {
        tasksCloudDemoPage.myTasksFilter().clickTaskFilter();
        tasksCloudDemoPage.taskListCloudComponent().getDataTable().checkContentIsDisplayed('Name', subTask.entry.name);
        tasksCloudDemoPage.taskListCloudComponent().getDataTable().selectRow('Name', subTask.entry.name);
