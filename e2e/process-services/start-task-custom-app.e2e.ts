...
describe('Start Task - Custom App', () => {
    ...
    it('[C263942] Should be possible to modify a task', () => {
        ...
        taskPage
            ...
            .then(() => {
                taskPage
                    .tasksListPage()
                    .getDataTable().checkContentIsDisplayed('Name', tasks[0]);
    ...
    it('[C263947] Should be able to start a task without form', () => {
        ...
        taskPage
            .tasksListPage()
            .getDataTable().checkContentIsDisplayed('Name', tasks[2]);
    ...
    it('[C263948] Should be possible to cancel a task', () => {
        ...
        taskPage.tasksListPage()
            .getDataTable().checkContentIsNotDisplayed('Name', tasks[3]);
    ...
    it('[C263949] Should be possible to save filled form', () => {
        ...
        taskPage
            .tasksListPage()
            .getDataTable().checkContentIsDisplayed('Name', tasks[4]);
    ...
    it('[C263951] Should be possible to assign a user', () => {
        ...
        taskPage.tasksListPage()
            .getDataTable().checkContentIsDisplayed('Name', tasks[5])
            .selectRow('Name', tasks[5]);
    ...
    it('[C263945] Should Information box be hidden when showHeaderContent property is set on false on custom app', () => {
        ...
        taskPage.tasksListPage().getDataTable().checkContentIsDisplayed('Name', showHeaderTask);
