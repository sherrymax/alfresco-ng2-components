...
describe('Task Details component', () => {
    ...
    it('[C260506] Should display task details for standalone task - Task App', async () => {
        ...
        taskPage.tasksListPage().getDataTable().checkContentIsDisplayed('Name', taskModel.getName());
    ...
    it('[C286708] Should display task details for subtask - Task App', async() => {
        ...
        processServices.goToTaskApp().clickTasksButton();
        taskPage.filtersPage().goToFilter(CONSTANTS.TASK_FILTERS.MY_TASKS);
        taskPage.tasksListPage().getDataTable().checkContentIsDisplayed('Name', taskName).selectRow('Name', taskName);
        ...
        taskPage.tasksListPage().getDataTable().checkContentIsDisplayed('Name', checklistName).selectRow('Name', checklistName);
        ...
        let taskModel = new TaskModel(allTasks.data[0]);
        taskPage.tasksListPage().getDataTable().checkContentIsDisplayed('Name', checklistTask.getName());
    ...
    it('[C286709] Should display task details for completed task - Task App', async() => {
        ...
        taskPage.tasksListPage().getDataTable().selectRow('Name', taskName);
        ...
        taskPage.tasksListPage().getDataTable().checkContentIsDisplayed('Name', completedTask.getName());
