...
describe('Start Task - Custom App', () => {
    ...
    it('[C286413] Task is displayed when typing into dueAfter field a date before the tasks due date', function () {
        ...
        taskListSinglePage.taskList().getDataTable().checkContentIsDisplayed('Name', paginationTasksName[0]);
    ...
    it('[C280515] Should be able to see only the tasks of a specific app when typing the apps id in the appId field', () => {
        ...
        taskListSinglePage.taskList().getDataTable().checkContentIsDisplayed('Name', app.taskName);
        taskListSinglePage.taskList().getDataTable().checkContentIsDisplayed('Name', app.taskName);
        taskListSinglePage.taskList().getDataTable().checkContentIsNotDisplayed('Name', paginationTasksName[13]);
    });
    ...
    it('[C280570] Should be able to see only the tasks with specific name when typing the name in the task name field', () => {
        ...
        taskListSinglePage.taskList().getDataTable().checkContentIsDisplayed('Name', paginationTasksName[13]);
    ...
    it('[C280629] Should be able to see only the task with specific taskId when typing it in the task Id field', () => {
        ...
        taskListSinglePage.taskList().getDataTable().checkContentIsDisplayed('Name', taskWithDueDate.name);
        expect(taskListSinglePage.taskList().getDataTable().numberOfRows()).toBe(1);
    });
    ...
    it('[C286589] Should be able to see only completed tasks when choosing Completed from state drop down', () => {
        ...
        taskListSinglePage.taskList().getDataTable().checkContentIsDisplayed('Name', completedTasks[0].name);
        taskListSinglePage.taskList().getDataTable().checkContentIsDisplayed('Name', completedTasks[1].name);
        taskListSinglePage.taskList().getDataTable().checkContentIsDisplayed('Name', completedTasks[2].name);
    ...
    it('[C286597] Should be able to see only running tasks when choosing Active from state drop down', () => {
        ...
        taskListSinglePage.taskList().getDataTable().checkContentIsNotDisplayed('Name', completedTasks[0].name);
        taskListSinglePage.taskList().getDataTable().checkContentIsNotDisplayed('Name', completedTasks[1].name);
        taskListSinglePage.taskList().getDataTable().checkContentIsNotDisplayed('Name', completedTasks[2].name);
        taskListSinglePage.taskList().getAllRowsNameColumn().then(function (list) {
            expect(Util.arrayContainsArray(list, allTasksName)).toEqual(true);
        });
